export default function githubIcon(props: {strokeWidth?: number; animated?: boolean }) {
		...
		<div className="max-h-20">
			<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
				...
				>
					<path
						strokeDasharray="30"
						strokeDashoffset={animated ? "30" : "0"}
					...
					>
						{animated && <animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="30;0" />}
					</path>
					<path
						strokeDasharray="10"
