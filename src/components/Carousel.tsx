...
export default function Carousel() {
	...
	var cards = [
		<Card
			key={val}
			title="Spok"
			review="Frase bonitinha de review é isso ai tmj 1 multiline de preferência pq nois n é de ferro né patrão"
			desc="Youtuber e Empresário"
			image={`https://randomuser.me/api/portraits/men/${val++}.jpg`}
		/>,
		<Card
			key={val}
			title="Marco Túlio"
			review="Frase bonitinha de review é isso ai tmj 2 multiline de preferência pq nois n é de ferro né patrão"
			desc="Youtuber e Empresário"
			image={`https://randomuser.me/api/portraits/men/${val++}.jpg`}
		/>,
		<Card
			key={val}
			title="LGGJ"
			review="Frase bonitinha de review é isso ai tmj 3 multiline de preferência pq nois n é de ferro né patrão"
			desc="Youtuber e Empresário"
			image={`https://randomuser.me/api/portraits/men/${val++}.jpg`}
		/>,
		<Card
